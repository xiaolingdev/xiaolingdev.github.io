...
const Activities = () => {
  const activityCategories = [
    {
      name: "政策說明會",
      activities: [
        { id: 1, title: "綠色能源政策說明會", date: "2024-07-15", location: "台北市政府大禮堂", image: "/images/green-energy-event.webp", externalLink: "https://example.com/green-energy-event" },
    ...
    },
    {
      name: "社區服務",
      activities: [
        { id: 3, title: "新北市淨灘活動", date: "2024-07-20", location: "新北市八里區海灘", image: "/images/beach-cleaning.webp", externalLink: "https://example.com/beach-cleaning" },
    ...
    },
    {
      ...
      activities: [
        ...
        { id: 6, title: "大學生政策研討會", date: "2024-08-15", location: "國立台灣大學", image: "/images/student-policy-forum.webp", externalLink: "https://example.com/student-policy-forum" }
      ]
    }
  ];

  const renderLink = (activity) => {
    if (activity.externalLink) {
      return (
        <a
          ...
          className="inline-flex items-center text-light-blue hover:text-light-purple transition-colors duration-300"
        >
          了解更多 <ExternalLink className="ml-2" size={16} />
        </a>
      );
    } else {
      return (
        <Link
          ...
          className="inline-flex items-center text-light-blue hover:text-light-purple transition-colors duration-300"
        >
          了解更多 <ArrowRight className="ml-2" size={16} />
        </Link>
      );
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-50">
      <h1 className="text-4xl font-bold mb-8 text-gray-800 text-center">活動報名</h1>
